...
For all tasks in this workshop, enter your commands in the Console (bottom left) (top tabs say 'console', 'terminal', (sometimes 'render') and 'background jobs').<br>
...
<br> 
`help("vector")` will provide you with information about the mean function in RStudio. 
...
[Task 3.2.2:]{.underline} Create a histogram for the pigs' weights, with axes labels.
